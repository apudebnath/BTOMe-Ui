    ...
    return (
        <div className="container py-5">
            <div class="row row-cols-1 row-cols-md-2">
                <div class="col  d-flex align-items-center justify-content-center "><div className="text-start">
                ...
                <div class="col"> <img className="w-100" src="https://z9d7c4u6.rocketcdn.me/wp-content/uploads/2016/09/furniture5_3-430x490.jpg.webp" alt="" /></div>
